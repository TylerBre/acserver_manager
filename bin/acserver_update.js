...
if (process.env.CI && process.env.CI == 'travis') {
  var cmd = `${path.join(steamcmd_dir, 'steamcmd.sh')} +login anonymous +force_install_dir ${install_dir} +@sSteamCmdForcePlatformType windows +app_update 302550 validate +quit`;
  install_steam(cmd);
